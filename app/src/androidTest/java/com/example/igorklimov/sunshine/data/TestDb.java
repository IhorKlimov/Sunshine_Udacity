...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Weather data doesn't match", cursor, weatherValues);
    ...
    public long insertLocation(SQLiteDatabase db) {
        ...
        // Insert ContentValues into database and get a row ID back
        long insert = db.insert(LocationEntry.TABLE_NAME, null, contentValues);
        assertTrue(insert != -1);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Content Values don't match", cursor, contentValues);
